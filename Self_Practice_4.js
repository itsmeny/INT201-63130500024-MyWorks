...
function BMI(weight, w_measurement_units, height, h_measurement_units) { // ฟังก์ชั่นที่ใช้คำนวณค่า BMI โดยจะรับค่า น้ำหนัก , หน่วยวัดของน้ำหนัก , ความสูง , หน่วยวัดของความสูง
    ...
    } else if (bmi_result >= 18.6 && bmi_result <= 24.9) { // ถ้า bmi_result มากกว่าหรือเท่ากับ 18.6 และไม่เกิน 24 ก็อยู่ในเกณท์ Normal
    ...
    } else { // ถ้า bmi_result มากกว่าหรือเท่ากับ 30 ก็อยู่ในเกณท์ Obesity
        bmi_result_text = 'Obesity';
    }

    return `Your BMI : ${bmi_result} || Be in line for : ${bmi_result_text}` // return ผลลัพธ์ทั้งหมดออกมาเป็น Your BMI : ${เลขผลลัพธ์ BMI ที่คำนวณ} || Be in line for : ${สถานะที่เป็นตัวหนังสือ}
